...
Eigen::Matrix4f get_model_matrix(float rotation_angle)
{
    ...
    rotation_angle = MY_PI * rotation_angle / 180.0;
...
Eigen::Matrix4f get_rotation(Vector3f axis, float angle)
{
    ...
    // TODO: Implement this function
    Eigen::Matrix4f matrixK;
    matrixK << 0, -axis.z(), axis.y(), 0,
                    axis.z(), 0, -axis.x(), 0,
                    axis.y(), axis.y(), 0, 0,
                    0, 0, 0, 1;
    projection = projection + sin(angle)*matrixK + (1-cos(angle))*matrixK*matrixK;
    // Create the projection matrix for the given parameters.
    // Then return it.
